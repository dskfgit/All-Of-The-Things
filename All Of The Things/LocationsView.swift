    ...
    private func addLocation() {
        withAnimation {
            let newLocation = Location(
                name: "41a Kinmond Ave",
                desc: "Our home in Brisbane"
            )

            let child1 = Location(
                name: "Kitchen",
                desc: "Our kitchen in Brisbane"
            )
            let child2 = Location(name: "Gym", desc: "Our kitchen in Brisbane")
            let child3 = Location(name: "Shed", desc: "Our kitchen in Brisbane")
            let child4 = Location(
                name: "Laundry",
                desc: "Our downstairs laundry in Brisbane"
            )
            let child5 = Location(
                name: "Des's Study",
                desc: "Des's upstairs study"
            )
            let child6 = Location(
                name: "Chez's Study",
                desc: "Chez's upstairs study"
            )
